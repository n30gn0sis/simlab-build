...
4. Afterwards, review `bundle-*/BUNDLE_NOTES.md`: treat any unresolved WARN line as a gate. Remind about the one manual category — licensed GNS3 appliances (`gns3/appliances/README.txt`); Dell firmware is not a bundle item since 2026-09-25 — and that the manifest must be regenerated after manual files are added.
