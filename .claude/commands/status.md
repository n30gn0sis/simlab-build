...
3. From `state/inventory/bundles.md`, report the latest bundle: date, versions, outstanding manual items (licensed appliances; Dell firmware is not a bundle item), and how stale rules/security debs are.
