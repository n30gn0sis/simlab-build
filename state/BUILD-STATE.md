...
| Current bundle | **`bundle-20260908` BUILT on VM 9770, amended 2026-09-12** — 15 GB, 1634 files, `verify` PASS WITH WARNINGS (exit 2), Ubuntu ISO GPG-verified. **Not yet transferred to the R770** — blocked on Dell downloads + licensed appliances + media. See `inventory/bundles.md`. **Note (2026-09-16):** `bundle-20260908` no longer physically exists on VM 9770 — it was wiped 2026-09-15 for a deployment test. `bundle-20260915` is what's actually on the VM now (and is what the 2026-09-16 rehearsal redeploy runs from), but it is explicitly a test artifact, not a transfer candidate for the R770 — this row's transfer status is unchanged. |
